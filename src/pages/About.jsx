...
const MILESTONES = [
  { version: 'v1.0', period: 'Mid-2026', desc: 'Forked from the creator of MiyoStream' },
];

export function About() {
  useSEO({
    title: 'About',
    description: 'Learn about TETO-STREAM — our story, mission, tech stack, and the team behind the platform. Available 24/7.',
  });
    ...
    <div className="pt-24 pb-20 px-6 min-h-screen animate-in fade-in duration-700">
      <div className="max-w-4xl mx-auto">
        ...
        <header className="mb-16 text-center">
          <img src="/logo.png" alt="TETO-STREAM logo" className="w-20 h-20 mx-auto rounded-2xl shadow-lg mb-6" />
          <h1 className="text-4xl md:text-6xl font-black text-white tracking-tighter uppercase mb-4">
            About <span className="text-accent animate-rgb-shift">TETO-STREAM</span>
          </h1>
        ...
        <section className="bg-surface/30 backdrop-blur-xl border border-white/5 p-8 rounded-[2rem] mb-8">
          ...
          <div className="space-y-4 text-text-secondary leading-relaxed text-sm md:text-base">
            <p>
              TetoStream started as a personal project — a single developer frustrated with fragmented streaming services,
        ...
        <section className="bg-accent/5 border border-accent/10 p-8 rounded-[2rem] mb-8">
          ...
          <p className="text-text-secondary leading-relaxed text-sm md:text-base">
            ...
            don't waste your time, and let the content speak for itself. TetoStream will always be
        ...
        <section className="bg-surface/30 backdrop-blur-xl border border-white/5 p-8 rounded-[2rem] mb-8">
          ...
          <div className="space-y-3">
            <a href="mailto:contact@tetocreations.bond" className="flex items-center gap-3 px-4 py-3 rounded-xl bg-accent/10 border border-accent/20 text-accent text-sm font-medium hover:bg-accent/20 transition-colors">
              <span>✉️</span> contact@tetocreations.bond
            </a>
            <a href="" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white/5 border border-white/5 text-text-secondary text-sm font-medium hover:text-text-primary hover:bg-white/10 transition-colors">
              <span></span> 
            </a>
          </div>
        </section>
