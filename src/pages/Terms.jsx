...
export function Terms() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: <>Community support, bug reports, feature requests, and code contributions are welcomed on the official <ExtLink href="https://github.com/cyber-winner/TETO-STREAM">TETO-STREAM GitHub repository</ExtLink>. For direct inquiries, contact <a href="mailto:contact@tetocreations.bond" className="text-accent underline decoration-accent/30 hover:decoration-accent transition-colors">contact@tetocreations.bond</a>.</>
    },
    {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-16 p-8 bg-accent/5 border border-accent/10 rounded-[2rem] text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <ExtLink href="https://github.com/cyber-winner/TETO-STREAM">
